...
public class BlogCommentService {
    ...
    /* 댓글 + 대댓글 작성 */
    @Transactional
    public void create(Long boardId, Long userId, BlogCommentCreateRequest req) {

        Blog board = boardRepository.findById(boardId).orElseThrow();
    ...
    public List<BlogCommentResponse> getList(Long boardId, String sort) {
