...
public class BlogController {
    ...
    private final BlogQueryService boardQueryService;
    private final BlogRecommendationService boardRecommendationService;
    private final BlogCommandService boardCommandService;
...
//    }
    ...
    @GetMapping("/{id}")
    public ApiResponse<BlogDetailResponse> getBoardDetail(
            @PathVariable Long id,
            @AuthenticationPrincipal CustomUserDetails userDetails
    ) {
        return ApiResponse.success(
